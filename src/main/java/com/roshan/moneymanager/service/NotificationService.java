...
import com.roshan.moneymanager.repository.ProfileRepository;
    ...
    public void sendDailyExpenseSummary(){
        ...
        for(ProfileEntity profile:profiles){
            ...
            if (!todayExpenses.isEmpty()){
                ...
                table.append("<tr><th style='border:1px solid #ddd;padding:8px;'>S No</th><th style='border:1px solid #ddd;padding:8px;'> Name</th><th style='border:1px solid #ddd;padding:8px;'>Amount</th><th style='border:1px solid #ddd;padding:8px;'>Category</th></tr>");
                int i=1;
