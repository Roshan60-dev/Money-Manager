...
public class IncomeService {
    ...
    public List<IncomeDTO> getCurrentMonthIncomesForCurrentUser(){
        ...
        List<IncomeEntity> expesnseList = incomeRepository.findByProfileIdAndDateBetween(profile.getId(),startDate,endDate);
